...
from views.sensor_settings import SensorSettingsView
...
def main():
    ...
    sensor_settings = SensorSettingsView(controller)
    ...
    controller.init_views(main_window, sensor_settings, adc_settings, control_panel, console)
    
    # Настройка интерфейса
    main_window.setup_ui(sensor_settings, adc_settings, control_panel, console)
